...
namespace ParserA85
{
    public class ParserA85 : IParser
    {
        public IProcessor Processor { get; set; }
        private A85ParserConfig mA85ParserConfig;

        public uint EntryPoint { get { return 0; } }
        public ParserA85(IProcessor processor)
        {
            Processor = processor;
            mA85ParserConfig = LoadSettings();
        }
        public string ParserName { get { return "ParserA85.ParserA85"; } }
        ...
        public object Settings { get { return mA85ParserConfig; } }

        public string[] Lines => throw new NotImplementedException();
        public void SaveSettings(object settings)
        {
            PreferencesBase.Save<A85ParserConfig>(settings as A85ParserConfig, A85ParserConfig.Key);
        }

        public A85ParserConfig LoadSettings()
        {
            return PreferencesBase.Load<A85ParserConfig>(A85ParserConfig.Key) as A85ParserConfig;
        }
        ...
        private string runAssembler(string filename, string workingDir)
        {
            ...
            var startInfo = new ProcessStartInfo(Path.Combine(mA85ParserConfig.AssemblerPath));
            startInfo.WindowStyle = ProcessWindowStyle.Hidden;
            startInfo.Arguments = string.Format(mA85ParserConfig.AssemblerArguments, fname, fname, Path.GetFileName(filename));
