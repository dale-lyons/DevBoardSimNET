...
LFF35:  cmp     #$43
        ...
        .byte   $11
LFF3B:  .byte   $BD
        .text   "P;/ ZAQ,MNBVCXKJHGFDSIUYTREW"
        .byte $00, $00, $0D, $0A, 'O'
        jmp     L002E
        .text   "_-:0987654321"
LFF6D:  jsr     SCOUT
...
LFFE3:  lda     #$2E
        jsr     OUTVEC
        jmp     QDDATD
INVEC:  jmp     $fb46           ; $FFEB = INVEC - normally points to INPUT $FB46
OUTVEC: jmp     $ff9b           ; $FFEE = OUTVEC - normally points to OUTPUT $FF9B
