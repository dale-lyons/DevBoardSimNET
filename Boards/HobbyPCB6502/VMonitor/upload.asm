...
PrtMsg1		lda   	Msg,x
		...
		inx
                jmp     PrtMsg1
PrtMsg2		rts
Msg             .text   "Begin XMODEM/CRC transfer."
                .byte   CR,LF
...
MsgCrcBadBlkno  .byte	CR,LF,CR,LF
		.text  	"Unexpected block number received"
 		.text	" Aborting"
		.byte 	CR,LF
		.byte 	0
MsgCrcDone	.byte 	CR,LF
                .text   "XMODEM-CRC download is complete"
		.byte 	0
