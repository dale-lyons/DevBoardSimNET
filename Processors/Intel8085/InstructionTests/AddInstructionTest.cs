...
{
    public class AddInstructionTest : RTest8085_8
    {
        public AddInstructionTest() : base("Add", InstructionCategoryEnum.Arithmetic, 0x80, nullFlags) { }
        ...
        public override BoardMessage formMessage(byte pReg, byte pVal, byte sReg, byte sVal, byte flags)
        {
            ...
            setBrdRegister(ret, (byte)SingleRegisterEnums.a, pVal);
