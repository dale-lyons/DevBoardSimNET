...
{// ld (ixy+d), nn
    public class LdMnnInstructionTest : RTestZ80_16
    {
        private ushort MAddr2;
        public LdMnnInstructionTest()
            : base("LdMnn", InstructionCategoryEnum.Z80, 0x36, nullFlags) { }
        ...
        {//ld (I?+d),nn
            ...
            byte[] buf = new byte[] { (byte)sVal, (byte)pVal };
            ret.ImmData = BitConverter.ToUInt16(buf, 0);
...
//            ret.Data = (byte)pVal;
        ...
        public override byte[] usePrimaryRegs() { return nullSingle; }
        ...
        {//ld (I?+d),nn
            var pRegS = ((DoubleRegisterEnums)sReg).ToString();
            ...
            processor.SystemMemory.SetMemory(0xa003, WordSize.OneByte, pVal, false);
        }
...
//            var pRegS = ((DoubleRegisterEnums)pReg).ToString();
            ushort simA = (ushort)processor.SystemMemory.GetMemory(MAddr2, WordSize.OneByte, false);
