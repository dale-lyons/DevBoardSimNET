...
namespace ARM7.Disassembler
{
    public class ArmElfLibReader
    {
        ...
        public string LibraryName { get { return libraryName; } }

        // end of accessor methods

        public ArmElfLibReader(string libraryName) :
            this(libraryName, false)
        { }

        public ArmElfLibReader(string libraryName, bool trace)
        {
        ...
        protected string checkFile()
        {
            ...
            while (filePos < fileLength)
            {
                ...
                string fileMagic = getString(58, fileHeader, 2);
        ...
        protected string getString(int offset, byte[] section, int len)
        {
        ...
        // Gets a string from a byte array, given its offset & length.
        protected string getNullTerminatedString(ref int offset, byte[] section)
        {
            StringBuilder sb = new StringBuilder();
            for (; ; )
            {
        ...
        protected int getDecNumber(int offset, byte[] section)
        {
