...
namespace ARM7
{
    ...
    /// </summary>
    public class GeneralPurposeRegisters : IRegisters
    {
        ...
        private RegisterChangedDelegate _registerChangedHandler;

        //a reference to the cpsr register. Needed to determine the current operating mode.
        public CPSR CPSR { get; private set; }
        ...
        public void SetSingleRegister(byte reg, uint val) { }
        public void SetDoubleRegister(string reg, uint val) { }
        public void SetDoubleRegister(byte reg, uint val) { }

        public uint GetSingleRegister(string reg) { return 0; }
		...
		private void setRegister(uint reg, uint newValue)
        {
            ...
            CPSR.CPUModeEnum cpuMode = CPSR.Mode;
        ...
        /// </summary>
        public RegisterChangedDelegate RegisterChangedHandler
        {
